		...
		<?php if( isset($row) ) : ?>
			<table class="table">
				<thead class="thead-dark">
                    ...
                    <th scope="col">Modificar</th> <!-- Nueva columna para editar -->
					</tr>
				</thead>
				<tbody>
					...
					<tr>
                        ...
                        <td><button onclick='mostrarAlerta(\"" . $row["nombre"] . "\", \"" . $row["marca"] . "\", \"" . $row["modelo"] . "\", \"" . $row["precio"] . "\", \"" . $row["detalles"] . "\", \"" . $row["unidades"] . "\")'>Modificar</button></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
